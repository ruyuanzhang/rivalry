...
elseif stereoMode == 1||stereoMode == 2||stereoMode == 5
    ...
    Screen('FillOval', win, rblumconst(1),movierect+[-20 -20 20 20]); %Draw blank for stimuli presentation
    ...
    Screen('FillOval', win, rblumconst(3),movierect+[-20 -20 20 20]); %Draw blank for stimuli presentation
end
